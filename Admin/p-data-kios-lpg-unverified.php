                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="page-header">
                            <h1>LIST <small>Kios LPG Baru</small></h1>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample-table-2">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                              ...
                                              <td class="center">
                                                      <a href="action-view-data-kios-unverified.php?id=<?php echo $row['id_pemilik'];?>" class="btn btn-xs btn-green tooltips" data-placement="top" data-original-title="View"><i class="clip-eye"></i></a>
