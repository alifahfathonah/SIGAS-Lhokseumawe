            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="action-add-data-kios.php" class="btn btn-green add-row">
                                    ...
                                    <table class="table table-bordered table-hover" id="sample-table-1">
                                        ...
                                        while ($row = mysql_fetch_array($query)){
                                          ...
                                          <tr>
                                              ...
                                              <td><?php echo $row['nik_pemilik'];?></td>
                                              ...
                                              <td class="center">
                                                      ...
                                                      <a href="action-edit-data-kios.php?id=<?php echo $row['id'];?>" class="btn edit-link btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                                      <a href="action-delete-data-kios.php?id=<?php echo $row['id'];?>" class="btn delete-link btn-xs btn-bricky tooltips" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a>

                                                      <div class="btn-group">

                                                          <ul role="menu" class="dropdown-menu pull-right">
                                                              <li role="presentation">
                                                                  <a role="menuitem" tabindex="-1" href="action-edit-data-kios.php?id=<?php echo $row['id'];?>">
                                                                      <i class="fa fa-edit"></i> Edit
                                                                  </a>
                                                              </li>
                                                              <li role="presentation">
                                                                  <a role="menuitem" tabindex="-1" href="action-delete-data-kios.php?id=<?php echo $row['id'];?>">
