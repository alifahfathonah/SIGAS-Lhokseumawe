            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <!--<p><button class="btn btn-danger btn-md" onclick="getLocation()">Posisi Anda</button>-->
                        <p><?php include "map.php" ?>
                          <!--
                        <p><button class="btn btn-danger btn-md" onclick="send_dijkstra()">Rute Terpendek</button>-->
                        <div class="map" id="map-canvas" style="height:720px;"></div>
                    </div>
                </div>
